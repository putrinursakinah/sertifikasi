                            ...
                            <div class="card-body">
                                @if ($sambutan)
                                    @foreach ($sambutan as $s)
                                        <!-- Judul dan Penulis -->
                                        <div class="meetup-header d-flex justify-content-between align-items-center mb-3">
                                            <div>
                                                <h6 class="mb-0 text-muted">Judul</h6>
                                                <h4 class="card-title">{{ $s->judul }}</h4>
                                            </div>
                                            <div class="text-right">
                                                <p class="card-text mb-0 text-muted">Penulis:</p>
                                                <p class="card-text mb-0">{{ $s->penulis }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media mb-3">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-0">Dokumen PDF</h6>
                                                <a href="{{ asset('storage/' . $s->isi) }}" target="_blank"
                                                    class="text-primary">
                                ...
                                @else
                                    ...
                                    <div class="meetup-header text-center">
                                        <h4 class="card-title mb-25">Belum Ada Sambutan</h4>
                                    </div>
                                @endif
                            </div>
                        </div>
