<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="{{ 'galeris/view' == request()->path() ? 'nav-item active' : 'nav-item' }}">
                <a class="nav-link collapsed" href="{{ url('galeris/view') }}"><i
                        data-feather="camera"></i>
                    <span class="menu-title text-truncate" data-i18n="Data Sekolah">Galeri</span>
                </a>
            </li>
            <li class=" nav-item">
